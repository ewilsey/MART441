...
function  initializeArray() {
  var myVFinder = new vFinder("Yellow Triangle","1/3 of the Tri-Force","Link","Nov 1998");
  var myVFinder1 = new vFinder("Cyan Square","Not quite sad, not quite hip.","Random Average Guy","2019");
  var myVFinder2 = new vFinder("Red Rupee","Worth 20 Green Rupees in Hyrule.","Biggoron","When You're Older");
  var myVFinder3 = new vFinder("Purple Pentagon","Barney's Intel HQ.","PBS","1992-2009");
  var myVFinder4 = new vFinder("Green Circle","Don't break the cipher!","Thurgood Jenkins","1998");
